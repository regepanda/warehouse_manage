/**
 * Created by zc on 2016/5/24.
 */

$admin_visualController.controller("admin_manage_humidity",function($scope,$timeout){
    ...
    $scope.getVisual = function()
    {
        ...
        d3.json("/api_D3_getEnvironment",function(error,data) {
            ...
            var svg = d3.select("#container_humidity")     //选择文档中的body元素
            ...
            var line_generator = d3.svg.line()
                ...
                .y(function(d){return scale_y(d.humidity);}) //1,3,5,,
            ...
            //定义y轴
            var y_axis = d3.svg.axis().scale(scale_y).orient("left") .ticks(20); //方向为朝左
            ...
            svg.selectAll("circle")
                ...
                .attr("cy", function(d) {
                    return scale_y(d.humidity) + margin.top;
                })
                .transition()
                .delay(function(d,i){
                    return i * 200;
